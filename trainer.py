...
def main(cfg : DictConfig):
    ...
    """wandb_logger = WandbLogger(project="Chengze_Reco", name=f"{params['num_epochs']}-num_epochs_lr{params['base_lr']}")  # TODO some logging routines might have to be adjusted
